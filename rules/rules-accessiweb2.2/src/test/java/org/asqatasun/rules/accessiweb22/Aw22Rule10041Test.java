...
public class Aw22Rule10041Test extends Aw22RuleImplementationTestCase {
    ...
    private void setUpRelatedContentMap(){
        ...
        relatedContentMap.put(getWebResourceMap().get("AW22.Test.10.4.1-2Failed-01_1"), relatedContent1);

...
public class Aw22Rule10042Test extends Aw22RuleImplementationTestCase {
    ...
    private void setUpRelatedContentMap(){
        ...
        relatedContentMap.put(getWebResourceMap().get("AW22.Test.10.4.2-2Failed-01_1"), relatedContent1);
        ...
        relatedContentMap.put(getWebResourceMap().get("AW22.Test.10.4.2-2Failed-01_2"), relatedContent2);

        List<String> relatedContent3 = new ArrayList<String>();
        relatedContent3.add("css/AW22.Test.10.4.2-2Failed-01_3.css");
        relatedContentMap.put(getWebResourceMap().get("AW22.Test.10.4.2-2Failed-01_3"), relatedContent3);
